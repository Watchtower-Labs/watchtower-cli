...
anthropic_observer = create_for_anthropic(api_key="your-key-here")
...
openai_observer = create_for_openai(api_key="your-key-here", model="gpt-4o")
...
# Note: Set your actual API key before running
import os
