...
/** Shape constraint for variants that have an `animate` property. */
interface AnimatableVariant {
  animate?: {
 ...
 */
export function withDelay<T extends AnimatableVariant>(variant: T, delay: number): T {
  return {
    ...variant,
    animate: {
      ...variant.animate,
 ...
 */
export function withDuration<T extends AnimatableVariant>(variant: T, newDuration: number): T {
  return {
    ...variant,
    animate: {
      ...variant.animate,
