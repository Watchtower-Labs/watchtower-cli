...
export default function TracesError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <p className="text-gray-400 text-sm mb-6">Could not connect to the trace directory. Make sure Watchtower is configured correctly.</p>
      <div className="flex gap-3">
        ...
        <Link href="/docs/troubleshooting" className="px-4 py-2 border border-white/10 text-gray-300 rounded-xl text-sm font-medium hover:border-white/20 transition-colors">Troubleshooting</Link>
      </div>
    </div>
  )
}
